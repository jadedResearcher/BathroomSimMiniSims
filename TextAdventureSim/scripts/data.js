...
const initFloorForegrounds = () => {
    ...
    floor_foregrounds[LIGHT] = [{ name: "Lamppost", src: "lamppost.png", desc: "It spreads its light over a vast area. It makes you feel safe." }, { name: "Lamp", src: "lamp.png", desc: "It's soothing and bright." }, {name: "Light Object", src: "Light_Object.png", desc: "How enlightening..." }];
...
const themeToAttackMultiplier = (key) => {
    ...
    rotation[SPACE] = 0.5;
    rotation[OCEAN] = 1.5;
    rotation[LONELY] = 0.25;
    rotation[FIRE] = 3.0;
    rotation[FREEDOM] = 1.5;
    rotation[STEALING] = 1.5;
    rotation[BURIED] = 0.5;
    rotation[FLESH] = 1.5;
    ...
    rotation[DECAY] = 2.0;
    rotation[CHOICES] = 4.13;//terezi
    rotation[ZAP] = 3.0;
    rotation[LOVE] = 2.0;
    rotation[SOUL] = 1.5;
    rotation[ANGER] = 2.0;
    rotation[WEB] = 1.8;
    rotation[ROYALTY] = 1.5;
    rotation[ENDINGS] = 1.5;
    rotation[KNOWING] = 1.5;
    rotation[GUIDING] = 1.5;
    rotation[CRAFTING] = 2.0;
    rotation[LANGUAGE] = 1.5;
    rotation[BUGS] = 1.66;
...
const themeToSpeedMultiplier = (key) => {
    ...
    rotation[ANGER] = 2.0;
    rotation[WEB] = 0.5;
    rotation[ROYALTY] = 0.5;
    rotation[ENDINGS] = 0.1;
    rotation[KNOWING] = 1.5;
    rotation[GUIDING] = 5.0;
    rotation[CRAFTING] = 0.4;
    rotation[LANGUAGE] = 0.5;
    rotation[BUGS] = 3.0;
    rotation[ADDICTION] = 2.0;
    rotation[SPYING] = 1.5;
    rotation[CLOWNS] = 3.0;
    rotation[DOLLS] = 3.0;
    rotation[OBFUSCATION] = 1.5;
    rotation[CENSORSHIP] = 1.5;
...
const themeToDefenseMultiplier = (key) => {
    ...
    rotation[LONELY] = 0.5;
    rotation[FIRE] = 0.3;
    rotation[FREEDOM] = 0.3;
    rotation[STEALING] = 0.53;
    rotation[BURIED] = 2.0;
    rotation[FLESH] = 2.0;
    rotation[SCIENCE] = 2.0;
    rotation[MATH] = 1.5;
    ...
    rotation[PLANTS] = 2.0;
    rotation[HUNTING] = 0.3;
    rotation[DECAY] = 0.5;
    rotation[CHOICES] = 1.5;
    rotation[ZAP] = 0.20;
    rotation[LOVE] = 2.0;
    rotation[SOUL] = 2.0;
    rotation[ANGER] = 0.1;
    ...
    rotation[CLOWNS] = 1.5;
    rotation[DOLLS] = 2.0;
    rotation[OBFUSCATION] = 0.5;
    rotation[CENSORSHIP] = 0.5;
    rotation[DARKNESS] = 0.5;
...
const initMonsterDesc = () => {
    ...
    monster_desc[KNOWING] = ["It knows your every secret as well as you do yourself.", "It knows your every secret with unerring accuracy.", "It clutches a stained and rotting book to its chest.", "Somehow you know it used to be someone you knew very well. Yourself."];
...
const initGeneralBackstories = () => {
    ...
    general_backstories[FREEDOM] = ["never let anyone tie them down", "have travel in your soul", "have never been able to settle down anywhere", "prides yourself in your freedom"];
...
const initChildBackstories = () => {
    ...
    child_backstories[ANGELS] = ["were raised in a convent", "grew up in a very religious family", "always felt the gods spoke to you growing up"];
...
function initThemes() {
    ...
    for (let key of keys) {
        ...
        string_possibilities[ICON] = emoji_possibilities[key];
